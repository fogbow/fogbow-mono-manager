...
public class TestCloudStackComputePlugin {
	...
	public void testGetInstances() {
		...
		Mockito.when(httpClient.doGet(Mockito.anyString())).thenReturn("{ \"listvirtualmachinesresponse\" : { \"count\":1 ,\"virtualmachine\" : []}}");
	...
	public void testGetInstance() {
		...
		String returned = "{ \"listvirtualmachinesresponse\" : { \"count\":1 ,\"virtualmachine\" : [  {\"id\":\"50b2b99a-8215-4437-9dfe-17382242e08c\",\"name\":\"ubuntu\""
				...
				+ "\"tags\":[],\"keypair\":\"admin-keypair\",\"affinitygroup\":[],\"displayvm\":true,\"isdynamicallyscalable\":false,"
				+ "\"ostypeid\":164} ] } }";
		Mockito.when(httpClient.doGet(Mockito.anyString())).thenReturn(returned);
		CloudStackComputePlugin cscp = createPlugin(httpClient);
		Token token = new Token("api:key", null, null, null);
		Instance instance =  cscp.getInstance(token, "50b2b99a-8215-4437-9dfe-17382242e08c");
		Assert.assertEquals("50b2b99a-8215-4437-9dfe-17382242e08c", instance.getId());
		Mockito.when(httpClient.doGet(Mockito.anyString())).thenReturn("{ \"listvirtualmachinesresponse\" : { \"count\":1 ,\"virtualmachine\" : []}}");
	    try{
