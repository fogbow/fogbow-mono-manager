...
public class ManagerFacade {
	...
	public ManagerFacade(Properties properties) throws Exception {
		...
		this.computePlugin = (ComputePlugin) createInstance("compute_class", properties);
		this.identityPlugin = (IdentityPlugin) createInstance("identity_class", properties);
	}
	...
	public ArrayList<ManagerItem> getItemsFromIQ(IQ responseFromWhoIsAliveIQ) {
