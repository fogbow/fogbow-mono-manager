...
public class OrderConstants {
	...
	public static final String FEDERATED_LABEL_TERM = "label";
	public static final String CIDR_NOTATION_TERM = "cidr";
	public static final String MEMBERS_TERM = "members";
