...
public class RequestResource extends ServerResource {
	...
	public String post() {		
		...
		//get attributes
		int numberInstanceRequest = FogbowUtils.getAttributeInstances(req.getHeaders());
		String typeResques = FogbowUtils.getAttributeType(req.getHeaders());
		Date validFromRequest = FogbowUtils.getAttributeValidFrom(req.getHeaders());
		Date validUntilRequest = FogbowUtils.getAttributeValidUntil(req.getHeaders());
